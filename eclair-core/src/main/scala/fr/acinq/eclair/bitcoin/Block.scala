...
object Block extends BtcSerializer[Block] {
  ...
  val LivenetGenesisBlock = {
    ...
    Block(
      BlockHeader(version = 1, hashPreviousBlock = Hash.Zeroes, hashMerkleRoot = "3ba3edfd7a7b12b27ac72c3e67768f617fc81bc3888a51323a9fb8aa4b1e5e4a", time = 1499957579, bits = 0x1f00ffff, nonce = 342485),
      List(
  ...
  val TestnetGenesisBlock = LivenetGenesisBlock.copy()

  val RegtestGenesisBlock = LivenetGenesisBlock.copy(header = LivenetGenesisBlock.header.copy(bits = 0x207fffffL, nonce = 1))
